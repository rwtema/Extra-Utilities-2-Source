...
public class ShapelessOreCompat extends ShapelessOreRecipe {
	public ShapelessOreCompat(Block result, Object... recipe) {
		super(result, recipe);
	}

	public ShapelessOreCompat(Item result, Object... recipe) {
		super(result, recipe);
	}

	public ShapelessOreCompat(@Nonnull ItemStack result, Object... recipe) {
		super(result, recipe);
	}
